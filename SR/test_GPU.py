...
import argparse
import numpy as np
img_path = '/media/sr617/29b9171f-dba6-4703-98a5-43495a4a4fe6/轻量级SR/DIV2K_valid_LR_bicubic/X4'
targeet_path = '/media/sr617/29b9171f-dba6-4703-98a5-43495a4a4fe6/轻量级SR/DIV2K_valid_HR'
...
def zhibiao(pred, gt):
    ...
    ssim_value = sim(spred, sgt, data_range=gt.max()-gt.min(), multichannel=True)
    imdff = pred - gt
